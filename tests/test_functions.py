...
@pytest.mark.parametrize('filename, ai_name, model_id, seed, test_dialogue', [
    ('tests/test4', 'Red', 'gpt-4o', 42, ['What is 2.45 divided by 2.44?', "2.45 divided by 2.44 is approximately 1.0041."]),
    ('tests/test5', 'Red', 'gpt-4o', 42, ['56th fibonacci number', 'The 56th Fibonacci number is 225851433717.']),
])
